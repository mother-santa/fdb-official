...
import { ChevronDown, Pause, Play, Smile, Trash2, UserPlus } from "lucide-react";
...
export const PostCreationForm = ({
    ...
    setIsNewUserFormOpen: (isOpen: boolean) => void;
}) => {
            ...
            <div className="flex items-center space-x-4">
                <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                        ...
                        <DropdownMenuItem onSelect={() => setIsNewUserFormOpen(true)}>
